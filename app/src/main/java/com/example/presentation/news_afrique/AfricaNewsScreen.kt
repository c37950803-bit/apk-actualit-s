...
/**
 * ============================================================================
 * COUCHE PRESENTATION (P) : ÉCRAN DES ACTUALITÉS D'AFRIQUE (MBPM)
 * ============================================================================
 */
@Composable
fun AfricaNewsScreen(
    viewModel: AfricaNewsViewModel,
    ...
    Column(
        modifier = modifier
            .fillMaxSize()
            .testTag("africa_news_screen")
    ) {
        NewsSearchTopBar(
            query = uiState.searchQuery,
            onQueryChange = viewModel::onSearchQueryChanged,
            onClearQuery = viewModel::clearSearch,
            placeholder = "Rechercher en Afrique (ex: ZLECAf, Cedeao, Addis-Abeba...)"
        )
            ...
            when {
                uiState.isLoading -> {
                    Column(
                        ...
                        Text(
                            text = "Chargement des actualités d'Afrique...",
                ...
                uiState.errorMessage != null && uiState.articles.isEmpty() -> {
                    Column(
                        ...
                        Button(
                            ...
                            modifier = Modifier.testTag("btn_retry_africa")
                        ) {
                ...
                uiState.articles.isEmpty() -> {
                    Column(
                        ...
                        Spacer(modifier = Modifier.height(12.dp))
                        Text(
                            text = "Aucun article disponible pour l'Afrique.",
                            style = MaterialTheme.typography.bodyLarge,
